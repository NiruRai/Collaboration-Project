...
<html>
 <body data-ng-app="myApp" class="ng-cloak"> <!--"data-ng-app" inform that the page in using angular js/class="ng-cloak" does not page to load partially  -->
	...
	<div class="panel panel-default" data-ng-show="editUser">
 ...
 <hr><input class="form-control" id="ex3" type="text" data-ng-model="searchname" placeholder="Search the name you want"><hr>
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                  <table class="table table-striped">
                      ...
                      <tbody>
                          <tr data-ng-repeat="u in ctrl.users | filter:searchname |orderBy :'username' "> <!-- Without anyvalue in serchbox it will short by alphabets otherwise value in the search box will be visible in the list -->
                              <td><span data-ng-bind="u.id"></span></td>
                              <td><span data-ng-bind="u.username"  data-ng-dblclick="ctrl.edit(u.id)" data-ng-model="editUser"></span></td> <!-- By doubleclicking the values of perticular contact will shown in the form  -->
                              <td><span data-ng-bind="u.lastname"></span></td>
                              <td><span data-ng-bind="u.address"></span></td>
                              <td><span data-ng-bind="u.email"></span></td>
                              <td><span data-ng-bind="u.mobile"></span></td>
                             <td>
